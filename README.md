...
- **[touch-thing](touch-thing/)** — Demonstrates the touch service API on Pebble Time 2 and Pebble 2 Duo. Subscribes to `touch_service` and visualizes touchdown, liftoff, and position-update events with live counters and a crosshair at the touch point.
